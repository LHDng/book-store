...
if (isset($_GET['delete'])) {
    ...
    if (mysqli_num_rows($check_book) > 0) {
      ...
      ';
        header("Refresh:2; url=http://localhost:8000/Assignment/online-bookstore/app/admin/view/admin_products.php", true, 303);
    } else {
            ...
            if (mysqli_num_rows($select_books) > 0) {
                while ($fetch_book = mysqli_fetch_assoc($select_books)) {
                    ...
                    <div class="box">
                        ...
                        <a href="admin_products.php?update=<?php echo $fetch_book['book_id']; ?>" class="option-btn">Edit</a>
                        <a href="admin_products.php?delete=<?php echo $fetch_book['book_id']; ?>" class="delete-btn"
                            onclick="return confirm('Bạn Muốn Xóa Quyển Sách Này?');">Xóa Sách</a>
                ...
                while ($fetch_update = mysqli_fetch_assoc($update_query)) {
                    ...
                    <form action="" method="post">
                        ...
                        <div class="text-box" style="display: grid;
                            ...
                            <input type="number" name="update_price" value="<?php echo $fetch_update['price']; ?>" class="box"
                                required placeholder="Nhập Giá Sách">

                            <input type="text" name="update_author" value="<?php echo $fetch_update['author']; ?>" class="box"
                                required placeholder="Nhập Tên Tác Giả">
                            <input type="text" name="update_publisher" value="<?php echo $fetch_update['publisher']; ?>" class="box"
                                required placeholder="Nhập Tên Nhà Xuất Bản">
